...
from db.main_db import get_user_by_mobile, create_user_record, create_order_record, get_user_orders, cancel_order_record, update_user_profile_pic, update_user_location, add_user_ref_img, delete_user_ref_img, update_order_items, update_order_location
...
def favicon():
    # If you have an actual icon in a 'static' folder:
    # return send_from_directory(os.path.join(app.root_path, 'static'),
    #                            'favicon.ico', mimetype='image/vnd.microsoft.icon')
    
    # Or just return an empty response to stop the 404 logs:
    return "", 204
